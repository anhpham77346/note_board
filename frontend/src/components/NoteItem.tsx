      ...
      >
        ...
        {isEditing ? (
          ...
          <div className="p-4 flex flex-col h-full relative group z-1">
            <div className="absolute right-2 top-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex space-x-1 bg-white/80 backdrop-blur-sm rounded-md p-0.5 shadow-sm">
              {onUpdate && (
                <button 
                  onClick={(e) => {
                    e.stopPropagation();
